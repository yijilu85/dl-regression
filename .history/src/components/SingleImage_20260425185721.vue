<template>
  <v-card :class="`mx-auto ${bgColor}`" max-width="1000">
    <v-container fluid>
      <v-row density="comfortable">
        ...
        <v-col>
          <div class="flex justify-center position-relative mb-12">
            <h2 class="flex justify-center">{{ headline }}</h2>
            <div class="position-abosolute top-2 right-2">
              <v-btn
                density="comfortable"
                icon="$close"
                variant="plain"
