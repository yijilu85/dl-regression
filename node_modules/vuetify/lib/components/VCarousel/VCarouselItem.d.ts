export declare const makeVCarouselItemProps: <Defaults extends {
    ...
    src: unknown extends Defaults["src"] ? {
        ...
        default: unknown extends Defaults["src"] ? string | import("vuetify/lib/components/VImg/VImg.mjs").srcObject : Defaults["src"] | NonNullable<string | import("vuetify/lib/components/VImg/VImg.mjs").srcObject>;
    };
