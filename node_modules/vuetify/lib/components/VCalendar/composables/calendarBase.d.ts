import { validateTimestamp, validateWeekdays } from 'vuetify/lib/components/VCalendar/util/timestamp.mjs';
import type { PropType } from 'vue';
import type { CalendarFormatter, CalendarTimestamp } from 'vuetify/lib/components/VCalendar/types.mjs';
import type { ColorValue } from 'vuetify/lib/composables/color.mjs';
...
export declare function useCalendarBase(props: CalendarBaseProps): {
    times: {
        now: {
            ...
            present: boolean;
            future: boolean;
            category?: import("vuetify/lib/components/VCalendar/types.mjs").CalendarCategory;
        };
        today: {
            date: string;
            time: string;
    ...
    locale: {
        ...
        messages: import("vue").Ref<import("vuetify/lib/types.mjs").LocaleMessages, import("vuetify/lib/types.mjs").LocaleMessages>;
        current: import("vue").Ref<string, string>;
        fallback: import("vue").Ref<string, string>;
        t: (key: string, ...params: unknown[]) => string;
        n: (value: number) => string;
        provide: (props: import("vuetify/lib/types.mjs").LocaleOptions) => import("vuetify/lib/types.mjs").LocaleInstance;
