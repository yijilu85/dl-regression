...
export declare const makeStepperProps: <Defaults extends {
    ...
    mobileBreakpoint: unknown extends Defaults["mobileBreakpoint"] ? PropType<number | import("vuetify/lib/types.mjs").DisplayBreakpoint> : {
        type: PropType<unknown extends Defaults["mobileBreakpoint"] ? number | import("vuetify/lib/types.mjs").DisplayBreakpoint : number | Defaults["mobileBreakpoint"] | import("vuetify/lib/types.mjs").DisplayBreakpoint>;
...
}, slots: VStepperSlots) => GenericProps<typeof props, typeof slots>) & import("vuetify/lib/util/index.mjs").FilterPropsOptions<{
