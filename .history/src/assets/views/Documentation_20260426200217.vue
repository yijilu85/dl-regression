  ...
  <div>
    ...
    <article>
      ...
      <p>
        ...
        anzeigt. Nach der Klassifikation werden die wahrscheinlichsten Labels
        und ihre Konfidenzwerte visualisiert. Zusätzlich können eigene Bilder
        per Drag-and-drop hochgeladen und im gleichen Ablauf ausgewertet werden.
      </p>
    </article>
  </div>
</template>
