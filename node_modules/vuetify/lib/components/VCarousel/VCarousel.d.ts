...
export declare const makeVCarouselProps: <Defaults extends {
    ...
    touch: unknown extends Defaults["touch"] ? {
        ...
        default: unknown extends Defaults["touch"] ? boolean | import("vuetify/directives/touch").TouchHandlers : Defaults["touch"] | NonNullable<boolean | import("vuetify/directives/touch").TouchHandlers>;
    };
