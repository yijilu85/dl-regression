  ...
  <div>
    ...
    <article>
      ...
      <p>
        ...
        preloaded. Bildgruppen enthalten einzelne Bildkarten, die jeweils ein
        Bild laden und klassifizieren. Nach der Klassifikation werden die
        wahrscheinlichsten Labels und ihre Konfidenzwerte visualisiert.
        Zusätzlich können eigene Bilder per Drag-and-drop hochgeladen und im
        gleichen Ablauf ausgewertet werden.
      </p>
    </article>
  </div>
</template>
