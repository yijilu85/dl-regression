...
export declare const makeVVirtualScrollProps: <Defaults extends {
    ...
    itemKey: unknown extends Defaults["itemKey"] ? {
        ...
        type: PropType<unknown extends Defaults["itemKey"] ? import("vuetify/lib/util/index.mjs").SelectItemKey : Defaults["itemKey"] | import("vuetify/lib/util/index.mjs").SelectItemKey>;
        default: unknown extends Defaults["itemKey"] ? import("vuetify/lib/util/index.mjs").SelectItemKey : Defaults["itemKey"] | NonNullable<import("vuetify/lib/util/index.mjs").SelectItemKey>;
    };
