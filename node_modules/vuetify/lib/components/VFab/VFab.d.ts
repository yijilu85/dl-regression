...
export declare const makeVFabProps: <Defaults extends {
    ...
    icon: unknown extends Defaults["icon"] ? import("vue").PropType<boolean | import("vuetify/lib/composables/icons.mjs").IconValue> : {
        type: import("vue").PropType<unknown extends Defaults["icon"] ? boolean | import("vuetify/lib/composables/icons.mjs").IconValue : boolean | Defaults["icon"] | import("vuetify/lib/composables/icons.mjs").IconValue>;
        default: unknown extends Defaults["icon"] ? boolean | import("vuetify/lib/composables/icons.mjs").IconValue : Defaults["icon"] | NonNullable<boolean | import("vuetify/lib/composables/icons.mjs").IconValue>;
    };
