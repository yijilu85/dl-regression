...
export declare const makeVAutocompleteProps: <Defaults extends {
    ...
    menuIcon: unknown extends Defaults["menuIcon"] ? {
        ...
        type: PropType<unknown extends Defaults["menuIcon"] ? import("vuetify/lib/composables/icons.mjs").IconValue : Defaults["menuIcon"] | import("vuetify/lib/composables/icons.mjs").IconValue>;
        default: unknown extends Defaults["menuIcon"] ? import("vuetify/lib/composables/icons.mjs").IconValue : Defaults["menuIcon"] | NonNullable<import("vuetify/lib/composables/icons.mjs").IconValue>;
    };
